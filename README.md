...
Below is the dynamic visualization generated by the simulation engine showing the Kruskal MST highway backbone (blue), the Outer Ring Road bypass (purple), and the resulting local road bottlenecks (red) under a 50,000-commuter load:

![Kukatpally Traffic Heatmap](assets/image_2fd7c9.jpg)
